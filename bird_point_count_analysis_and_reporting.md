...
View the most current version at https://github.com/paulvpop/bird_point_count_analysis_and_reporting/edit/main/bird_point_count_analysis_and_reporting.md
...
names(pc_data2)
```
Uncomment (remove hash) and install a package necessary for the species accumulation curve
```
...
We will have to split the data since there are too many sites to be represented
in an A4 size sheet.
